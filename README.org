...
[[https://github.com/Jamie-Cui/git-overleaf/actions/workflows/melpazoid.yml][https://github.com/Jamie-Cui/git-overleaf/actions/workflows/melpazoid.yml/badge.svg]]
...
push runs ~git-overleaf-push~.  Active Git-only transient arguments are
rejected.  Selecting the logical remote from Magit's ordinary "fetch
...
Magit's normal behavior.  Explicit =O= fetch bypasses the automatic
refresh throttle.
...
| =O= | Overwrite the remote after confirmation. |
